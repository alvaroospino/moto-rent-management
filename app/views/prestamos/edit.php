...
<div class="page-container">
    <!-- Botón de Regreso -->
    <a href="<?= BASE_URL ?>prestamos/show/<?= $prestamo['id_prestamo'] ?>" class="back-button">
    ...
    <div class="form-container">
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <p class="form-subtitle">Modifique la información del préstamo #<?= $prestamo['id_prestamo'] ?></p>
            </div>
            ...
            <!-- Form -->
            <form action="<?= BASE_URL ?>prestamos/update/<?= $prestamo['id_prestamo'] ?>" method="POST" class="form-body">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" id="monto_prestamo" name="monto_prestamo" step="0.01" min="0.01"
                                   value="<?= $prestamo['monto_prestamo'] ?>" class="form-input" style="padding-left: 2.5rem;" required>
                        </div>
                        <p class="help-text">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="fecha_prestamo" name="fecha_prestamo"
                               value="<?= $prestamo['fecha_prestamo'] ?>" class="form-input" required>
                        <p class="help-text">
                            <i class="fas fa-info-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" name="descripcion" class="form-textarea"
                                  placeholder="Describa el motivo del préstamo (opcional)"><?= htmlspecialchars($prestamo['descripcion']) ?></textarea>
                        <p class="help-text">
                            <i class="fas fa-info-circle"></i>
                ...
                <div class="form-actions">
                    <a href="<?= BASE_URL ?>prestamos/show/<?= $prestamo['id_prestamo'] ?>" class="btn btn-secondary">
