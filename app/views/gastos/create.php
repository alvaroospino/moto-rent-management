    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold flex items-center">
                <i class="fas fa-plus-circle mr-3 text-yellow-100"></i>
                Nuevo Gasto Operacional
            </h1>
            <p class="text-yellow-100 mt-2">Registra un nuevo gasto de tu negocio</p>
        </div>
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-yellow-700">
                    Este formulario registra gastos que reducen la utilidad del negocio. Para gastos que debe pagar el cliente,
                    use la opción de "Préstamo/Cargo" en el detalle del Contrato.
                </p>
            </div>
        </div>
    </div>
    ...
    <form action="<?= BASE_URL ?>gastos/store" method="POST" class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
                ...
                <input type="date" name="fecha_gasto" id="fecha_gasto" value="<?= $fechaHoy ?>" required
            ...
            <div class="lg:col-span-2 bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-xl p-6">
                ...
                <textarea name="descripcion" id="descripcion" rows="4" required
                          ...
                          placeholder="Describe detalladamente el gasto. Ej: Cambio de aceite y filtro para la moto placa XYZ123, incluyendo mano de obra y repuestos."></textarea>
        ...
        <div class="mt-8 flex flex-col sm:flex-row justify-end gap-4">
            ...
            <button type="submit"
                    class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white rounded-xl font-semibold transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5">
